<!-- File: /app/views/registrations/registrations.ctp -->
<p>Total number of registrations: <?php echo count($registrations); ?> | <?php echo $this->Html->link('Export', array('controller' => 'registrations', 'action' => 'export', 'registrations.csv')); ?></p>
<table>
    <tr>
			<th>Contact</th>
			<th>Chapter</th>           
    ...
    <tr>   
			<td>            
            	<?php 
					echo $this->Html->link($registration['Contact']['fname'].' '.$registration['Contact']['lname'], array('controller' => 'contacts', 'action' => 'view', $registration['Registration']['contact_id'])); 
					if ($registration['Contact']['member_type'] == 'ADV') echo ' (Adviser)';
				?>        
            </td> 
			<td>
